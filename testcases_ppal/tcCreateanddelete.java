...
public class tcCreateanddelete {
  ...
  @Test
  public void testTcCreateanddelete() throws Exception {
    driver.get(baseUrl + "/");
    ...
    driver.findElement(By.id("emergency_name")).clear();
    driver.findElement(By.id("emergency_name")).sendKeys("Tsunami");
    driver.findElement(By.id("emergency_description")).clear();
    driver.findElement(By.id("emergency_description")).sendKeys("High tides");
    ...
    driver.findElement(By.cssSelector("button.btn.btn-primary")).click();
    driver.findElement(By.linkText("Tsunami")).click();
    driver.findElement(By.id("delete")).click();
    assertTrue(closeAlertAndGetItsText().matches("^Are you sure you want to delete[\\s\\S]$"));
    driver.findElement(By.xpath("//div[@id='app-navbar-collapse']/ul[2]/li/a/span")).click();
